...
public class SchedaNuotoAssegnataBean {
    private String idScheda;
    private String emailUser;
    private int distanzaTotale;
    private int durata;

    public SchedaNuotoAssegnataBean() {}

    public SchedaNuotoAssegnataBean(String idScheda, String emailUser, int distanzaTotale, int durata) {
